 ...
 */
export type ManagedWindowWebSocketSurfaceFailure =
  | "none"
  | "frame_timeout"
  | "helper_closed"
  | "helper_error"
...
export type ManagedWindowWebSocketInputStage =
  | "none"
  | "focus_ready"
  | "pointer_move_ready"
...
export type ManagedWindowWebSocketInputFailureDetail =
  | "none"
  | "xtest_unavailable"
  | "xtest_busy"
  | "xtest_invalid"
...
export type ManagedWindowWebSocketInputBoundaryStage =
  | "none"
  | "requested"
  | "helper_ready"
  | "revalidation_ready"
...
export type ManagedWindowWebSocketHelperStopReason =
  | "none"
  | "capture_failure"
  | "input_failure"
  | "stdin_end"
...
export type ManagedWindowWebSocketHelperCrashClass =
  ...
  | "host_module"
  | "unknown";
export type ManagedWindowWebSocketHelperCrashOrigin =
  | "none"
  | "uncaught_exception"
  | "unhandled_rejection"
  | "unknown";
export type ManagedWindowWebSocketHelperCrashErrorKind =
  | "none"
  | "error"
  | "type_error"
  | "range_error"
  | "other";
export type ManagedWindowWebSocketHelperCrashMessageClass =
  | "none"
  | "focus_not_owned"
  | "window_not_active"
