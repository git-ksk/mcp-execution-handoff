...
function scheduleKeyboardKey(key){if(!inputPolicy.key)return;clearPendingKeyboardKey();pendingKeyTimer=setTimeout(function(){pendingKeyTimer=0;if(compositionPhase==='idle')sendCritical({kind:'key',key:key})},0)}
