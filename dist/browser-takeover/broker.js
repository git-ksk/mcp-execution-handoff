...
function sendGestureScroll(g,x,y){const dx=x-g.lastX,dy=y-g.lastY;g.lastX=x;g.lastY=y;if(Math.hypot(x-g.startX,y-g.startY)>18)g.moved=true;if(g.moved&&(dx||dy))sendRealtime({kind:'scroll',deltaX:browserScrollDelta(dx),deltaY:browserScrollDeltaY(dy)})}
