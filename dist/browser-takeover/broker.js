...
let clientBinding=randomClientBinding();let cap='';let reconnectHandle='';let clientGeneration=0;let inputPolicy={tap:true,scroll:true,text:true,key:true};let pc=null;let critical=null;let realtime=null;let primaryButtonDown=false;let primaryButtonPoint=null;let primaryReleaseTimer=0;let stopped=false;let suspended=false;let suspendPromise=Promise.resolve();let generationReleasePromise=null;let reconnectPromise=null;let recoveryReconnectUsed=false;let gesture=null;let pinch=null;let viewScale=1;let viewPanX=0;let viewPanY=0;let aimMode=false;let orientationResetTimer=0;let composing=false;let keyboardMode=false;let keyboardMirror='';let failureInProgress=false;let connectionStartedAt=0;let firstFrameMs=null;let firstFrameTimer=0;let metricsSamplesSent=0;let inputMetricsSamplesSent=0;let metricsTimer=0;let latestFrameMetrics={};let lastTapSentAt=0;let relayState='disabled';let relayTimer=0;let editableRegions=[];let editableRegionsAt=0;let keyboardFallbackTimer=0;let iceCandidateCounts={host:0,srflx:0,prflx:0,relay:0};let iceGatherStartedAt=0;let completionState='idle';let verificationPollTimer=0;
