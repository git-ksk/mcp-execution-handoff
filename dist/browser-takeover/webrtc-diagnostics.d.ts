...
export type WebRtcDiagnosticStage = "broker.prepare.request" | "broker.prepare.success" | "broker.prepare.failure" | "broker.reconnect.conflict.active_lease" | "broker.generation.release.suspend" | "broker.generation.release.peer_loss" | "relay.credential.unavailable" | "browser.gather.complete" | "browser.peer.state" | "broker.connect.request" | "server.answer.ready" | "broker.connect.success" | "broker.connect.failure" | "server.peer.state" | "host.target.alive" | "host.target.missing" | "host.window.ready" | "host.window.failure.none" | "host.window.failure.multiple" | "host.window.successor.probe" | "host.window.successor.admitted" | "host.window.successor.returned" | "host.window.successor.none" | "host.window.successor.ambiguous" | "host.window.successor.unsupported" | "host.window.successor.failure" | "host.media.window_text" | "host.capture.started" | "host.frame.ready" | "host.input.focus.ready" | "host.input.tap.sent" | "host.input.pointer.helper_ready" | "host.input.pointer.helper_failure" | "host.input.pointer.move_ready" | "host.input.pointer.authority_ready" | "host.input.pointer.down_sent" | "host.input.pointer.post_authority_ready" | "host.input.pointer.delivery_helper_ready" | "host.input.pointer.delivery_helper_failure" | "host.input.pointer.delivery_arm_failure" | "host.input.pointer.delivery_wait_no_from_server_creator_match" | "host.input.pointer.delivery_wait_no_from_server_creator_mismatch" | "host.input.pointer.delivery_wait_no_from_server_creator_unknown" | "host.input.pointer.delivery_wait_swapped" | "host.input.pointer.delivery_wait_short_data" | "host.input.pointer.delivery_wait_no_event" | "host.input.pointer.delivery_wait_event_mismatch" | "host.input.pointer.delivery_wait_xi2_mismatch" | "host.input.pointer.delivery_wait_window_mismatch" | "host.input.pointer.delivery_wait_coord_mismatch" | "host.input.pointer.delivery_wait_io_failure" | "host.input.pointer.delivery_wait_failure" | "host.input.pointer.delivery_ready" | "host.input.editable_helper_ready" | "host.input.editable_helper_unavailable" | "host.input.text.native_ax" | "host.input.text.pid_keyboard" | "host.input.text.event_creation_failure" | "host.input.text.activation_rejected" | "host.input.text.native_boundary_rejected" | "host.input.failure" | "host.capture.failure" | "host.capture.failure.x11" | "host.capture.failure.encoder" | "host.capture.failure.option" | "host.capture.failure.other";
