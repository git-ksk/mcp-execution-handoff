...
import { type TakeoverBrokerConfig, type TakeoverHostTarget, type TakeoverInterventionRef } from "./broker.js";
import { type SpawnedWebRtcRuntimeProviderConfig } from "./webrtc-runtime-diagnostics.js";
...
export declare class BrowserHandoffAdapterError extends Error {
    readonly code: "BROWSER_HANDOFF_UNAVAILABLE" | "BROWSER_HANDOFF_TARGET_INVALID";
    constructor(code: "BROWSER_HANDOFF_UNAVAILABLE" | "BROWSER_HANDOFF_TARGET_INVALID", message: string);
}
/**
